...
class Gallery
{
    ...
    static function rtcl_gallery_content($post = null, $conf = array()) {
        ...
        ?>
        <style type="text/css">
            #rtcl-gallery-upload-ui-wrapper .rtcl-gallery.roklot-gallery,
            .roklot-gallery{
                opacity: 1 !important;
            }
        </style>
        <div class="form-group">
            <div id="rtcl-gallery-upload-ui-wrapper"
                ...
                <div class="rtcl-gallery roklot-gallery">
                    <p><?php _e("Drop files here to add them.", "classified-listing") ?></p>
                    <p><a href="#" id="rtcl-gallery-browse-button"
                          class="rtcl-gallery-browse-button btn btn-primary <?php echo $button ?>"><?php _e("+ Add Photo", "classified-listing") ?></a>
                    </p>
                </div>
                <div class="rtcl-gallery-uploads"></div>
                <div class="description alert alert-danger">
                    <?php
                    $image_size = Functions::get_option_item('rtcl_misc_settings', 'image_size_gallery', array());
                    /*printf(
                    ...
                    printf(
                        __("<p>Please be patient as they load.</p>", "classified-listing") );
                    ?>
                </div>
